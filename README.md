...
<main class="hero">
    <div class="hero-content">
        ...
        <p class="description">
            I design and operate intelligent, automated cloud systems that integrate
            large language models with production-grade infrastructure. My work focuses on
            building reliable, observable, and cost-aware AI pipelines using cloud-native
            technologies, containers, and workflow automation.
        </p>
